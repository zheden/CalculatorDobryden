...
public:
	Element(function<double(double,double)> func):_f(func){}
...
{
public:
	Node(function<double(double,double)> func):_f(Element(func)){}
	...
	double operator()(double a, double b){return _f(a,b);}
